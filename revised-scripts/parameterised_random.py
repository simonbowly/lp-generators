...
@write_instance(write_tar_encoded, 'data/parameterised_random/inst_{seed}.tar')
...
def run(seed_values):
    ...
    print('Generating fixed size parameterised instances.')
    instances = tqdm(
    ...
    with open('data/parameterised_random.json', 'w') as outfile:
